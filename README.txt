E4U HR & Payroll Cloud System v2.6.3 — Production Payroll + Approval Patch
...
- Payroll adjustments can be Supabase-backed when v2.6.3 SQL add-on is installed.
...
- supabase-v2.6.3-addon.sql

The app will not break if you have not run the add-on SQL yet. It will use local browser fallback for the new v2.6.3 features until the tables exist.
